  ...
  <div class="min-h-dvh flex flex-col bg-white dark:bg-background">
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 py-24 sm:py-32 text-center relative overflow-hidden">
      ...
      <div class="relative mb-6">
        <span class="text-[10rem] sm:text-[14rem] font-black leading-none text-transparent bg-clip-text bg-linear-to-b from-brand-bright via-[#0F8F21] to-[#0F8F21]/60 select-none drop-shadow-xs">
          404
        </span>
        <div class="absolute inset-0 blur-[80px] opacity-15 bg-linear-to-br from-brand-bright to-[#0F8F21] rounded-full scale-110"></div>
      </div>

      <div class="w-16 h-1 rounded-full bg-linear-to-r from-brand-bright to-[#0F8F21] mb-8"></div>
      ...
      <router-link
        to="/"
        class="group relative inline-flex items-center gap-2.5 bg-linear-to-r from-[#0F8F21] to-brand-bright hover:from-brand-bright hover:to-[#0F8F21] text-white font-semibold text-base px-10 py-4 rounded-xl transition-all duration-300 shadow-xl shadow-[#0F8F21]/30 hover:shadow-brand-bright/40 hover:scale-[1.02] active:scale-[0.98]"
      >
