...
<template>
  ...
  <div v-if="showIcon('soccer')">
    <svg
      ...
      :class="size"
      class="fill-current text-brand-bright"
    >
      <path
  ...
  <!-- Basketball  -->
  <div v-else-if="showIcon('basketball')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
      :class="size"
  ...
  <!-- Cricket  -->
  <div v-else-if="showIcon('cricket')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
      :class="size"
  ...
  <!-- Ice Hockey  -->
  <div v-else-if="showIcon('iceHockey')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 32 32"
  ...
  <!-- Table Tennis  -->
  <div v-else-if="showIcon('tableTennis')">
    <svg
      :class="size"
      class=""
      xmlns="http://www.w3.org/2000/svg"
  ...
  <!-- Handball  -->
  <div v-else-if="showIcon('handball')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
      :class="size"
  ...
  <!-- American Football  -->
  <div v-else-if="showIcon('americanFootball')">
    <svg
      :class="size"
  ...
  <!-- Volleyball -->
  <div v-else-if="showIcon('volleyball')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
      :class="size"
  ...
  <!-- Waterpolo  -->
  <div v-else-if="showIcon('waterpolo')">
    <svg
      id="Capa_1"
      :class="size"
      class=""
  ...
  <!-- eSoccer  -->
  <div v-else-if="showIcon('eSoccer')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 26 18"
  ...
  <!-- Aussie Rules  -->
  <div v-else-if="showIcon('aussieRules')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 32 32"
  ...
  <!-- Horse Racing -->
  <div v-else-if="showIcon('horseRacing')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 26 26"
      :class="size"
  ...
  <!-- Snooker -->
  <div v-else-if="showIcon('snooker')">
    <svg
      data-v-5ab2086d=""
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
  ...
  <!-- Motorsports -->
  <div v-else-if="showIcon('motorSport')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
      :class="size"
  ...
  <!-- Badminton -->
  <div v-else-if="showIcon('badminton')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 32 32"
  ...
  <!--  Baseball -->
  <div v-else-if="showIcon('baseball')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
      :class="size"
  ...
  <!--  Cycling -->
  <div v-else-if="showIcon('cycling')">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 -960 960 960"
      :class="size"
