  ...
  >
    ...
    >
      <div class="flex-col items-center justify-center h-full w-full">
        ...
        <div
          class="text-xs mt-1 flex capitalize items-center justify-center font-semibold sm:text-xs whitespace-nowrap text-gray-900 dark:text-white"
        >
          {{ item.name }}
        </div>
      </div>
