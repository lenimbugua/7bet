      ...
      <div class="flex justify-between space-x-3 md:space-x-5 items-center">
        ...
        <div v-if="!token" class="flex space-x-3 items-center">
          ...
          <RouterLink
            :to="{ name: 'signup' }"
            :class="['text-white']"
            class="flex items-center justify-center bg-brand-bright hover:bg-brand-selected text-sm md:text-md rounded-md whitespace-nowrap font-semibold md:font-extrabold md:py-1 px-1.5 sm:px-3 h-10 shadow-sm transition-colors duration-200"
          >
            Join Now
          </RouterLink>
        </div>
