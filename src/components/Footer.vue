...
const socials = [
  {
    name: "X",
    href: "https://x.com/paristake71501",
    viewBox: "0 0 24 24",
    path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z",
  },
  {
    name: "Instagram",
    href: "https://www.instagram.com/paristake1/",
    viewBox: "0 0 24 24",
  ...
  {
    name: "Facebook",
    href: "https://web.facebook.com/people/7bet/61582216861245/",
    viewBox: "0 0 24 24",
    path: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z",
  },
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@paristake?is_from_webapp=1&sender_device=pc",
    viewBox: "0 0 24 24",
...
const quickLinks = [
  ...
  { label: "Casino", to: { name: "casino" } },
  { label: "Promotions", to: { name: "promotions" } },
];

const supportLinks = [
  { label: "Affiliate Program", to: { name: "join-affiliate" } },
];
...
<template>
  <footer class="w-full pb-24 sm:pb-0 mt-8 md:mt-12 bg-gray-100 dark:bg-[oklch(12%_0.03_258)] border-t border-border/50">
    <div class="max-w-420 mx-auto px-4 sm:px-8 pt-10 pb-6">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <!-- <div class="mt-4 flex items-center gap-2">
            ...
            <div>
              <p class="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground/50 leading-none">BCLB Licensed</p>
              <p class="text-xs font-bold text-muted-foreground tabular-nums mt-0.5">BK 0000777</p>
            </div>
          </div> -->
        </div>
      </div>
      ...
      <!-- License text -->
      <p class="text-[10px] leading-relaxed text-muted-foreground/40 text-center max-w-lg mx-auto mb-5">
        7bet Kenya is authorized and regulated by the BCLB (Betting Control and Licensing Board) under the Betting, Lotteries and Gaming Act, Cap 131, Laws of Kenya.
      </p>
