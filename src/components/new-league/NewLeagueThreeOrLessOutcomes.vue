        ...
        <div class="flex p-1 md:ps-6 justify-between">
          ...
          <div class="odds flex flex-wrap gap-1">
            <div class="flex flex-wrap items-center gap-0.5 justify-end">
              <button
                class="whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent px-2 md:px-4 flex flex-col text-xs shrink h-8 text-primary font-bold w-11 sm:w-16 rounded-l-md bg-[#DEF5EA] dark:bg-red-500/15 hover:text-primary space-x-1 dark:text-gray-300 items-center justify-center"
              >
                <!---->
                <div class="">2.36</div></button
              ><button
                class="whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent px-2 md:px-4 flex flex-col text-xs shrink h-8 text-primary font-bold w-11 sm:w-16 bg-[#DEF5EA] dark:bg-red-500/15 hover:text-primary space-x-1 dark:text-gray-300 items-center justify-center"
              >
                <!---->
                <div class="">3.13</div></button
              ><button
                class="whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent px-2 md:px-4 flex flex-col text-xs shrink h-8 text-primary font-bold w-11 sm:w-16 rounded-r-md bg-[#DEF5EA] dark:bg-red-500/15 hover:text-primary space-x-1 dark:text-gray-300 items-center justify-center"
              >
                <!---->
                <div class="">3.13</div>
              </button>
